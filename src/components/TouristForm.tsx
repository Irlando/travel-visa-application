...
export default function TouristForm({ language, onBack }: TouristFormProps) {
  const [formData, setFormData] = useState<Partial<TouristFormData>>({
    acceptedTerms: false,
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">
          {language === 'en' ? 'Tourist Application Form' : 'Formulário de Pedido Turista'}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">
              {language === 'en' ? 'Passport Information' : 'Informações do Passaporte'}
            </h3>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">
              {language === 'en' ? 'Travel Information' : 'Informações da Viagem'}
            </h3>
            ...
            <div>
              <label className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-700">
                  {language === 'en' ? 'I already have a visa' : 'Já tenho um visto'}
                </span>
              </label>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">
              {language === 'en' ? 'Accommodation Information' : 'Informações de Acomodação'}
            </h3>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="mt-2 text-sm text-gray-600">
                {language === 'en'
                  ? 'By submitting this form, you agree to our processing of your personal data for visa application purposes. Your data will be handled in accordance with our privacy policy and applicable data protection laws.'
                  : 'Ao enviar este formulário, você concorda com o processamento de seus dados pessoais para fins de solicitação de visto. Seus dados serão tratados de acordo com nossa política de privacidade e leis de proteção de dados aplicáveis.'}
              </p>
            </div>
          </div>
